...
class UserController extends Controller
{
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['User']))
		{
                       ...
                       if (!empty($model->activation_key)) $criteria->addCondition('activation_key = "'.$model->activation_key.'"');
                       ...
                       if (!empty($model->last_visit)) $criteria->addCondition('last_visit = "'.$model->last_visit.'"');
                     
                    	
                       if (!empty($model->avatar)) $criteria->addCondition('avatar = "'.$model->avatar.'"');
