...
array(
			'name' => 'person',
			'type' => 'raw',
			'value' => $model->person !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->person)), array('person/view', 'id' => GxActiveRecord::extractPkValue($model->person, true))) : null,
			),
	),
)); ?>
